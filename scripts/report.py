...
def report_combined_content(dict):
    ...
    if is_eligible == 1:
        analysis_str = "Based on the information provided and using the Global Debt Service Coverage Ratio, your business can support the amount requested.  However, the final decision on approval is subject to underwriting and additional factors.  See the 5 C’s of credit. "
    else:
        analysis_str = "Based on the information provided and using the Global Debt Service Coverage Ratio, your business can not support the amount requested.  However, the final decision on approval is subject to underwriting and additional factors.  See the 5 C’s of credit. "
    ...
    document.add_paragraph("Keep the largest balance in business & personal checking accounts as possible to increase capacity and average daily balance.", style='List Bullet')  
    document.add_paragraph("The higher the balance it helps with cash flow on the bank statements. ", style='List Bullet')
    document.add_paragraph("Continue to pay all bills on time.  The Home Equity Line and Revolving have the fastest impact on your personal credit score.", style='List Bullet')
    document.add_paragraph("To improve the Global Debt Service Coverage Ratio, either increase income or decrease debt. ", style='List Bullet')
    document.add_paragraph("To improve Debt-to-Owing Ratio (DTO) and Debt-to-Income Ratio (DTI) either increase income or decrease debt.", style='List Bullet')
    document.add_paragraph("Enroll in Business Credit Accelerator Program.  See www.keysforbusiness.com/masterclass for more information.", style='List Bullet')
